    ...
    render() {
        return (
            <ul className="sub-menu">
                <li className="sub-menu__item is-completed"><a href="#" className="sub-menu__link">Basic Info
                    <img src="./src/components/sidebar/sidebar-navigation/sub-navigation/check-mark.svg" className="check-mark"/></a></li>
